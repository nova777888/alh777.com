...
function showRegisterModal() {
  showModal(
    ...
    '<div style="margin-bottom:14px;display:none;"><label style="display:block;font-size:13px;font-weight:600;color:#0a1c2f;margin-bottom:4px;">Email Address <span style="color:#8aaeb9;font-weight:400;">(optional)</span></label>' +
    ...
    '<div style="margin-bottom:14px;display:none;"><label style="display:block;font-size:13px;font-weight:600;color:#0a1c2f;margin-bottom:4px;">Verification Code</label>' +
