...
function renderBalance(balance) {
  ...
  el.innerHTML = '<div class="acc-grid-2">' +
    '<div class="acc-info-item"><span class="acc-label">Available Balance</span><span class="acc-value acc-balance">
...
function resetPasswordWithCode() {
 ...
 + parseFloat(balance.available_balance || 0).toFixed(2) + '</span></div>' +
    '<div class="acc-info-item"><span class="acc-label">Total Earned</span><span class="acc-value">
  var name = user.name || user.username || "User";
  var phone = user.phone || "N/A";
  var email = user.email || "";
  var refId = user.referral_code || user.public_id || user.ref_id || "N/A";
...
function resetPasswordWithCode() {
 ...
 + parseFloat(balance.total_earned || 0).toFixed(2) + '</span></div>' +
    '<div class="acc-info-item"><span class="acc-label">Total Withdrawn</span><span class="acc-value">
  var name = user.name || user.username || "User";
  var phone = user.phone || "N/A";
  var email = user.email || "";
  var refId = user.referral_code || user.public_id || user.ref_id || "N/A";
...
function resetPasswordWithCode() {
 ...
 + parseFloat(balance.total_withdrawn || 0).toFixed(2) + '</span></div>' +
    '</div>';
}
